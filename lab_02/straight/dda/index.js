...
// function translateStraightDda(){
//     const newX = Number(document.getElementById("x-new").value);//input usuário
//     const newy = Number(document.getElementById("y-new").value);//input usuário
//     const x1 = Number(document.getElementById("x-1").value);
//     const y1 = Number(document.getElementById("y-1").value);
//     const x2 = Number(document.getElementById("x-2").value);
//     const y2 = Number(document.getElementById("y-2").value);
...
//     draw_pixel(Math.round(x)+newX, Math.round(y)+newY, true);
